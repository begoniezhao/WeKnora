...
const messages = {
  ...
  "ja-JP": {
    "embedPublish": {
      ...
      "awaitingToken": "ホストページからのトークンを待機中…",
      "preview": "プレビュー",
    ...
    "chat": {
      ...
      "otherSource": "その他の出典",
      "webGroupIntro": "以下の{count}件は次の出典によるものです",
    ...
    "agentStream": {
      ...
      "toolStatus": {
        ...
        "queryUnderstanding": "質問を理解中...",
        "queryUnderstandDone": "質問を理解しました",
