...
type KnowledgeService interface {
	...
	// RebuildKnowledgeBaseIndex re-processes all documents in a knowledge base.
	// Used when the indexing strategy changes and existing documents need to be re-indexed.
	// Returns the number of documents enqueued for re-processing.
	RebuildKnowledgeBaseIndex(ctx context.Context, kbID string) (int, error)
